...
void Klient::zapisz_do_grupy(Grupa_zajeciowa* grupa, Klient klient) //metoda dodajaca Klienta do grupy zajeciowej
{
...
void Klient::zapisz_do_dietetyka(int dzien, double godzina, int cena, Dietetyk* dietetyk, Klient* klient) //metoda zapisujaca Klienta na wizyte do dietetyka
{
...
void Klient::zapisz_na_trening(int dzien, double godzina, string rodzaj, Trener* trener, Klient* klient) //metoda zapisujaca Klienta na trening personalny do trenera
{
...
void Klient::uaktualnij_dane(string imie, string nazwisko, string imie_rodzica, string nazwisko_rodzica) //metoda, ktora uaktualnia dane Klienta
{
	_imie = imie;
	_nazwisko = nazwisko;
...
void Klient::dodaj_karte_zdrowia(Karta_zdrowia k ) //metoda ktora dodaje karte zdrowia do Klienta
{
