...
vector <Grupa_zajeciowa*> vector_grupa;
Harmonogram *h1;
void wybor_strefy();
...
void recepcjonista(Recepcjonista*zalogowany) 
{
    ...
    {
    case 1:
        cout << "Nasi aktualni klienci: " << endl;
        for (int i = 0; i < vector_klient.size(); i++)
        {
            cout << "Imie i Nazwisko: " << vector_klient[i]->get_imie() << " " << vector_klient[i]->get_nazwisko() << endl; //wypisujemy wszystkich kientow posiadajacyhc u nas konto
        }
        recepcjonista(zalogowany);            //wracamy do menu recepcjonisty
    case 2:
       
        cout << "Stworz gupe zajeciowa: " << endl;
        cout << "Podaj godzine zajec: " << endl;
        cin >> g;
        cout << endl;
        cout << "Podaj liczbe uczestnikow: " << endl;
        cin >> l;
        cout << endl << "Podaj numer sali: " << endl;
        cin >> s;
        cout << endl << "Podaj dzien tygodnia: " << endl;
        ...
        cout << "5.Piatek" << endl;
        cin >> d;
        cout << endl << "Podaj rodzaj zajec: " << endl;
        cin >> rodzaj;
        zalogowany->dodaj_grupe(g, l, s, d, rodzaj, vector_trener[1]);     //dodajemy grupe zajeciowa
        cout << "Grupa zostala dodana!" << endl;
        recepcjonista(zalogowany);
        
    case 3:
        cout << "Podaj informacje o  gupie, ktora chcesz usunac: " << endl;
        cout << "Podaj godzine zajec: " << endl;
        cin >> g;
        cout << endl;
        cout << "Podaj liczbe uczestnikow: " << endl;
        ...
        cout << endl << "Podaj rodzaj zajec: " << endl;
        cin >> rodzaj;
        zalogowany->usun_grupe(g, l, s, d, rodzaj, vector_trener[1]); //usuwamy grupe
    case 4:
        wybor_strefy();              //po wylogowaniu wracamy do menu glowego i wyboru stref
        break;
    default:
        recepcjonista(zalogowany);                    //w innym przypadku wracamy do menu recepcjonisty aby urzytkownik mogl poprawnie wybrac swoj zamiar
        break;
    }
...
int main()
{
    ...
    h1->dodaj_grupe_do_harmonogramu(g1);
    h1->dodaj_grupe_do_harmonogramu(g2);
