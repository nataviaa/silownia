...
void Klient::zapisz_do_dietetyka(int dzien, int godzina, int cena, Dietetyk* dietetyk, Klient* klient) {
...
void Klient::zapisz_na_trening(int dzien, int godzina, string rodzaj, Trener* trener, Klient* klient, Harmonogram *harmonogram) {
